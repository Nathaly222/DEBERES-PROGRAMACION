...
export function toRna(input: string): string {
  ...
  // que representa la secuencia de ADN que se va a convertir,
  ...
  const dictionary: { [key: string]: string } = {
    ...
    // Por ejemplo, 'G' se mapea a 'C', 'C' se mapea a 'G', y así sucesivamente.
    G: 'C',
    C: 'G',
    T: 'A',
    A: 'U',
  ...
  let temp = '';
   //Se inicializa una variable temporal temp como una cadena vacía.
